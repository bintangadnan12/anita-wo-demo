    ...
    <footer className="bg-ink text-white/70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          <div className="md:col-span-4">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/55 max-w-xs italic">
              "Hari Spesialmu, Urusan Kami" — WO, Dekor, MUA & Attire terlengkap di Metro Lampung.
            </p>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>Dekorasi Adat & Modern</li>
              <li>MUA Profesional</li>
              <li>Attire & Busana</li>
              <li>Entertainment</li>
            </ul>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-x py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/45">
          ...
          <div className="italic font-display text-sm text-gold/70">#anitaweddingorganizer</div>
        </div>
      </div>
    </footer>
  );
